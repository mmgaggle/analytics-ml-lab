...
RUN echo 'PS1="\u@\h:\w\\$ \[$(tput sgr0)\]"' >> /root/.bashrc \
    ...
    && yum install -y curl wget tree bzip2    
...
RUN mkdir $HOME/.jupyter \
    ...
    && $CONDA_DIR/bin/conda install --yes --quiet jupyter 'notebook=5.7.*' $(while read requirement; do echo \'$requirement\'; done < /home/requirements.txt) \
